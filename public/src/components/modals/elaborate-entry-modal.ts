...
export class ElaborateEntryModal extends LitElement {
    selectedEntry: any;
    grams: number;
                    ...
                    <div class="modal-content rounded-4 shadow-sm">
                        ...
                        <div class="modal-body px-3 pt-2 pb-0">
                            ...
                            <h6 class="fw-normal mb-2" style="font-size: 0.85em;">
                                ${this.selectedEntry?.name || this.selectedEntry?.product?.name}
                            </h6>
...
customElements.define('elaborate-entry-modal', ElaborateEntryModal);
